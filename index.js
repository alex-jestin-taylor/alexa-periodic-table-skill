...
{
    var sentence = "The element, " + item.name + " has the number " + item.number + ". Which other element would you like to know about?";
    return sentence;
}
...
{
    return "Here is your " + counter + "th question.  What is the " + formatCasing(property) + " of "  + item.name + "?";
...
function getAnswer(property, item)
{
    ...
    {
        case "Abbreviation":
            return "The " + formatCasing(property) + " of " + item.name + " is <say-as interpret-as='spell-out'>" + item[property] + "</say-as>. "
        break;
        default:
            return "The " + formatCasing(property) + " of " + item.name + " is " + item[property] + ". "
        break;
    }
}
...
var WELCOME_MESSAGE = "Welcome to the Periodic Table Quiz Game!  You can ask me about any of the one hundred and eighteen elements and their attributes, or you can ask me to start a quiz.  What would you like to do?";  

//This is the message a user will hear when they start a quiz.
var START_QUIZ_MESSAGE = "OK.  I will ask you 10 questions about the Periodic Table.";

//This is the message a user will hear when they try to cancel or stop the skill, or when they finish a quiz.
var EXIT_SKILL_MESSAGE = "Thank you for playing the Periodic Table Quiz Game!";

//This is the message a user will hear after they ask (and hear) about a specific data element.
var REPROMPT_SPEECH = "Which other element would you like to know about?";

//This is the message a user will hear when they ask Alexa for help in your skill.
var HELP_MESSAGE = "I know lots of things about the Periodic Table.  You can ask me about an element, and I'll tell you what I know.  You can also test your knowledge by asking me to start a quiz.  What would you like to do?";
